...
class ControllerShippingDpdfrpredict extends Controller {
    ...
    public function index() {
        ...
        if (isset($this->request->post['dpdfrpredict_retour']))
            $data['dpdfrpredict_retour'] = $this->request->post['dpdfrpredict_retour'];
        else
            $data['dpdfrpredict_retour'] = $this->config->get('dpdfrpredict_retour');
