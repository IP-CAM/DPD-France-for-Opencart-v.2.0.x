...
class ControllerShippingDpdfrrelais extends Controller {
    ...
    public function index() {
        ...
        if (isset($this->request->post['dpdfrrelais_retour']))
            $data['dpdfrrelais_retour'] = $this->request->post['dpdfrrelais_retour'];
        else
            $data['dpdfrrelais_retour'] = $this->config->get('dpdfrrelais_retour');
