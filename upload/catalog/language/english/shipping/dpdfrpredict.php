...
$_['text_predictblock'] = '
    ...
    <div class="module" id="predict">
        ...
        <div class="copy">
            ...
            <ul>
                <li><b>A parcel delivery in a 1-hour time window (choice is made by SMS or through our website)</b></li>
            ...
            <ul>
                ...
                <li>On the day of delivery, a text message will specify you a 1-hour time window.</li>
            </ul>
        </div>
        <br/>
